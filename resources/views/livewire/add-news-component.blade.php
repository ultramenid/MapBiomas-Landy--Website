<div>
    <x-cms.page-header title="New news">
        <x-slot:actions>
    ...
    <div class="max-w-3xl space-y-4">
        <x-cms.panel title="Details">
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <x-cms.select name="category" label="Category"
                              :options="['' => 'Category', 'news' => 'News', 'event' => 'Event']"
                              wire:model="category" />
            </div>
        </x-cms.panel>

        <x-cms.panel title="Cover image">
            <x-cms.image-upload model="photo" hint="JPG or PNG." :preview-url="$photo?->temporaryUrl()" />
        </x-cms.panel>
                ...
                <x-cms.panel title="English content">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-cms.rich-text field="contentEN" :height="480"></x-cms.rich-text>
                        </div>
                    </div>
                </x-cms.panel>
            </x-slot:en>
                ...
                <x-cms.panel title="Konten Bahasa Indonesia">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <x-cms.rich-text field="contentID" :height="480"></x-cms.rich-text>
                        </div>
                    </div>
                </x-cms.panel>
            </x-slot:idn>
